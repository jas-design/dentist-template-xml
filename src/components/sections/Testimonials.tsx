            ...
            <div className="relative pt-12">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-4">
                  <button className="w-12 h-12 rounded-full border-2 border-slate-100 flex items-center justify-center text-dark-navy hover:bg-primary hover:text-white hover:border-primary transition-all duration-300 cursor-pointer">
                    <ChevronLeft size={20} />
                  </button>
                  <button className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white hover:bg-dark-navy transition-all duration-300 shadow-lg shadow-primary/20 cursor-pointer">
